    ...
    if (schedules[currentDay]) {
        schedules[currentDay].forEach((schedule, index) => {
            ...
            if (currentTime >= scheduleStartTime && currentTime < scheduleEndTime) {
                ...
                // If it's within 5 minutes of the end of the current schedule, show "Coming Soon" notice
                ...
                // Set the next schedule time for auto-refresh
                nextScheduleTime = scheduleEndTime;
            }
        });
    }

    // Display the current schedule in the designated area
